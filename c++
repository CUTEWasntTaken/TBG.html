...
<body>
    ...
    <script>
        ...
        var rooms = {
            'start': {
                'title': 'The Shop',
                'description': 'You are in a mechanic shop. There are doors to the north and east.',
            ...
            'library': {
                ...
                'description': 'You find yourself surrounded by dusty books. There\'s a door to the south or you can go west.',
                'image': 'library.jpg',
                'directions': {
                    'south': 'start',
            ...
            'garage': {
                'title': 'garage',
                'description': 'you can see a garage full of cars that where fixed.',
                'image': 'car.jpg',
                'directions': {
                    'east': 'start',
                    'north': 'Dyno room'
            ...
            'Dyno room': {
                'title': 'Dyno Room',
                'description': 'you are in a room where cars are dynoed to see the Horse Power the car has.',
                'image': 'car.jpg',
                'directions': {
                    'south': 'garage',                 
                }
